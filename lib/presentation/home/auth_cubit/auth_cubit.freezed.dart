...
/// @nodoc
mixin _$AuthState {
  ConnectedUser? get user => throw _privateConstructorUsedError;
...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ConnectedUser? user, AuthStatus status});
...
class _$_AuthState implements _AuthState {
  const _$_AuthState({this.user, this.status = const AuthStatus.initial()});
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      {final ConnectedUser? user, final AuthStatus status}) = _$_AuthState;

  @override
  ConnectedUser? get user;
  @override
...
class __$$_InitialCopyWithImpl<$Res>
    extends _$AuthStatusCopyWithImpl<$Res, _$_Initial>
